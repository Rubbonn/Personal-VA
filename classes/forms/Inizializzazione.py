...
class Inizializzazione(Form):
	...
	callsign: StringField = StringField('Callsign', validators=[InputRequired('Devi inserire un callsign per l\'aereo'), Length(max=30, message='Il callsign deve essere più corto di 30 caratteri')])
